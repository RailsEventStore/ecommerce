...
module ClientOrders
  class TimePromotionsTest < InMemoryTestCase
    cover "ClientOrders::CreateTimePromotion*"
    cover "ClientOrders::AssignStoreToTimePromotion*"
    cover "ClientOrders.current_time_promotions_for_store"
    ...
    def test_returns_active_promotion_with_its_attributes
      ...
      result = ClientOrders.current_time_promotions_for_store(store_id)
