...
ActiveRecord::Schema[8.1].define(version: 2026_08_31_121258) do
  ...
  create_table "client_orders_time_promotions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.integer "discount"
    t.datetime "end_time"
    t.string "label"
  ...
  create_table "orders_time_promotions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.integer "discount"
    t.datetime "end_time"
    t.string "label"
    t.datetime "start_time"
  ...
  create_table "shipments_products", force: :cascade do |t|
    t.string "name"
    t.uuid "uid", null: false
    t.index ["uid"], name: "index_shipments_products_on_uid", unique: true
  end
