...
class TimelineDeliveryProcessTest < ProcessTest
  ...
  def test_delivers_new_post_to_current_followers
  ...
  def test_delivers_new_post_to_each_current_follower
    process(::Social::UserFollowed.new(data: { follower_id: alice, followee_id: bob }))
  ...
  def test_does_not_deliver_to_followers_of_other_authors
